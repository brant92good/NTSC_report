...
%    (臺大碩士、博士論文的Latex模板)
%%
\documentclass[hyperref,UTF8,12pt,a4paper]{class/ncku_class}
...
% \usepackage[showframe]{geometry}  % 框架顯現出來確認有沒有超出margin
...
\usepackage{hyperref}
\hypersetup{unicode,colorlinks, citecolor=blue,filecolor=blue,linkcolor=blue,urlcolor=blue}
